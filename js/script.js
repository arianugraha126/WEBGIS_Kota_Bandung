...
// Buat pane dengan urutan layer sesuai prioritas visual
map.createPane('landcoverPane');
map.getPane('landcoverPane').style.zIndex = 400;

map.createPane('jembatanPane');
map.getPane('jembatanPane').style.zIndex = 800;

map.createPane('adminPane');
map.getPane('adminPane').style.zIndex = 600;
